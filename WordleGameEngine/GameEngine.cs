...
public class GameEngine : IGameEngine
{
    ...
    private IncorrectGuessHints ManageIncorrectGuessHints(string guess, string Wordle)
    {
    ...
    private IncorrectGuessHints GetIncorrectGuessHints(string guess, string Wordle)
    {
